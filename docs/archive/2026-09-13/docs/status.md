> **ARCHIVED — may be out of date.** Historical session evidence;
> not current deployment state or instructions to repeat old actions.
> Read [current findings](../../../../../HomeHub/docs/PANEL_CURRENT_2026-09-13.md) first.
